...
export const translations: Record<string, Translations> = {
  es: {
    ...
    about: {
      ...
      description2: "Con más de 5 años de experiencia en el desarrollo web, he trabajado con empresas líderes como Meta y Riot Games, contribuyendo a proyectos que impactan a millones de usuarios.",
  ...
  en: {
    ...
    about: {
      ...
      description2: "With over 5 years of experience in web development, I've worked with leading companies like Meta and Riot Games, contributing to projects that impact millions of users.",
